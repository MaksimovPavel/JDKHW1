...
public class ServerWindow extends JFrame {
    ...
    private LinkedList<ClientGUI> clientGUILinkedList;


    public ServerWindow() {
        clientGUILinkedList = new LinkedList<>();
    ...
    public boolean connectUser(ClientGUI clientGUI) {
        ...
        clientGUILinkedList.add(clientGUI);
        return true;
    }
    ...
    public void disconnectUser(ClientGUI clientGUI) {
        clientGUILinkedList.remove(clientGUI);
        if (clientGUI != null) {
    ...
    private void answerAll(String text) {
        for (ClientGUI clientGUI : clientGUILinkedList) {
    ...
    public Component createButtons() {
        ...
        btnStop.addActionListener(e -> {
            if (!isServerWorking) {
                ...
                while (!clientGUILinkedList.isEmpty())
                    disconnectUser(clientGUILinkedList.getLast());
                appendLog(date());
